package lxpsee.top.wordcount.wc3;
 ...
 * <p>
 * file:///D:\workDir\otherFile\temp\2019-1\wc\testdata file:///D:\workDir\otherFile\temp\2019-1\wc\output3
 */
public class WordCountMRAppMasterByCombiner {
    public static void main(String[] args) throws Exception {

        Configuration configuration = new Configuration();
        Job job = Job.getInstance(configuration);
        job.setJarByClass(WordCountMRAppMasterByCombiner.class);
