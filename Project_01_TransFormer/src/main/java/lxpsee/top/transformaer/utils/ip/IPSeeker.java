package lxpsee.top.transformaer.utils.ip;
 ...
 * Created by 努力常态化 on 2019/3/19 16:03.
 * <p>
...
public class IPSeeker {
    ...
    private static IPSeeker instance = null;     // 单一模式实例
    private long ipBegin, ipEnd;                 // 起始地区的开始和结束的绝对偏移
    private IPLocation loc;                      // 为提高效率而采用的临时变量
    ...
    private String readString(long offset) {
        try {
            ...
            if (i != 0) return IPSeekerUtils.getString(buf, 0, i, "GBK");
        } catch (IOException e) {
            System.out.println(e.getMessage());
        }
        return "";
